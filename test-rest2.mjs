...
const testDoc = doc(db, 'rooms/ABCDEF/players/123');

async function test() {
  await setDoc(testDoc, { name: 'test' });
  console.log("Created doc");
  
  const res = await fetch(`https://firestore.googleapis.com/v1/projects/fictio-7fcc4/databases/(default)/documents/rooms/ABCDEF/players/123`, {
    method: 'DELETE'
  });
